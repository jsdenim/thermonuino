...
//HSCLK---13
//HMOSI--11
// Mapping adapte au cablage propose:
// BUSY -> D7, RES -> D8, D/C -> D9, CS -> D10
#define isEPD_W21_BUSY digitalRead(7) 
#define EPD_W21_RST_0 digitalWrite(8,LOW)
#define EPD_W21_RST_1 digitalWrite(8,HIGH)
#define EPD_W21_DC_0  digitalWrite(9,LOW)
#define EPD_W21_DC_1  digitalWrite(9,HIGH)
#define EPD_W21_CS_0 digitalWrite(10,LOW)
